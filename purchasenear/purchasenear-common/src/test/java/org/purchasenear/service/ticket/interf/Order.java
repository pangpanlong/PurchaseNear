...
public class Order implements java.lang.Cloneable, java.io.Serializable
{
    ...
    {
        __outS.writeLong(orderId);
        __outS.writeString(phone);
        __outS.writeString(orderNum);
        __outS.writeInt(orderDate);
        __outS.writeInt(ticketType);
        __outS.writeDouble(amount);
        __outS.writeInt(orderStatus);
    }

    public void
    ice_read(Ice.InputStream __inS)
    {
        orderId = __inS.readLong();
        phone = __inS.readString();
        orderNum = __inS.readString();
        orderDate = __inS.readInt();
        ticketType = __inS.readInt();
        amount = __inS.readDouble();
        orderStatus = __inS.readInt();
    }
